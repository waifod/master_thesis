...
tribe from a comprehension category. Also, in this way weak equivalences and
fibrations are preserved by maps between objects in the category we are
considering and the same goes for pullbacks along fibrations.
...
$\cC\rightarrow\cD$, but I don't know how to specify this.

2- Take the 1-category of $\infty$-category with fibrations and weak equivalences, then localize at categorical equivalences. What do the hom-spaces look like?

It's important to relate the hom-spaces $\FibCat_\infty(\cP,\cQ)$ to the ones we want, that is $\Fun_{lex}(\cP,\cQ)$. Also, what are the ones of $\Lexi$ like?
