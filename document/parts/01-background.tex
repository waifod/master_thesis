...
categories was developed by Voevodsky in \cite{Voe14b,Voe14b,Voe15a,Voe15b},
  where he starts from a \emph{universe category}. His methods were
...
If we could do that, then, under the proper conditions,
...
Currently, researchers often assume this conjecture to be true because, thanks
to what is known in folklore as the \emph{syntax-semantic adjunction}, it
provides \emph{internal languages},
an intuitive notation to reason about contextual categories.
We shall not use such instruments
...
\begin{defn}
  ...
  We shall say that the the $\Pis$-structure satisfies the
