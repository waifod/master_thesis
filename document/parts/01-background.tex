...
\begin{rmk}
  Assuming the conjecture, some homotopical models of dependent type
  theories have been produced, like \emph{type-theoretic fibration categories}
  \cite{Shu14} and
  \emph{$\infty$-toposes} \cite{Shu19}, which however carry much more structure
  as they also model some logical rules. As a concrete example, in \cite{KL12}
...
\begin{notation}
  ...
  still define small essentially algebraic theory with sorts indexed by
