...
\begin{rmk}
  Our definition differs slightly from Browsn's (REF) because he only asks for
  $W$ to be closed under the 2-out-of-3 property, BUT...
\end{rmk}
...
\end{prop}
\begin{proof}
  It suffices to note that at no point the proof by Lumsdaine depends on the
  other structures.
\end{proof}
