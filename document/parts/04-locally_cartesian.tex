...
\begin{cor}\label{fincompl1}
  ...
  $\infty$-category $L(N(\Syn{T}))$ is finitely complete.
\end{cor}
\begin{proof}
...
\colon\Gamma.\Psi\rightarrow\Gamma.\Psi.p^*_\Psi\Pis(\Delta,p^*_\Delta\Psi),\]
  ...
  $g(y):\Pi(\Delta,\Theta)$ such that
  \[\Gamma, x:\Delta\vdash\app(g(y),x)\equiv\app(f,y):\Theta.\]
...
\begin{lem}[\cite{Kap14}]\label{lccfc}
