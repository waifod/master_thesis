...
properties is equivalent to producing a contextual categories with the specified
...
statement true (see \cite{Ras18} for a candidate). Also, so far we have
been unable to explicitly construct the corresponding contextual category from
an $\infty$-category in general, meaning that we do not have homotopical
inverses to the localization functors.
