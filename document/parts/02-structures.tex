...
\begin{construction}
  ...
  $z\colon\Gamma.A.\Theta\rightarrow\Gamma.\Sigmas(A,\Theta).\Psi$
  such that $p_\Psi\cdot z=\pair_{A,\Theta}$ a section
  $\csplit_z\colon\Gamma\Sigmas(A,\Theta)
  \rightarrow\Gamma.\Sigmas(A,\Theta).\Psi$ satisfying
  $\csplit_z\cdot\pair_{A,\Theta}=z$. This will be done using
  $\unpair_{A,\Theta}$, which is constructed like $\pair_{A,\Theta}$.
\end{construction}
