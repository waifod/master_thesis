...
\begin{lem}\label{extpistruct}
  Given a dependent type theory with $\Pis$-types $\bfT$, the data provided
...
\begin{lem}[{\cite[Lem.\ 5.6]{Kap17}}]\label{piequal}
  Given a dependent type theory with $\Pis$-types $\bfT$ and an iterated context
...
\begin{lem}[{\cite[Prop.\ 3.3.1]{Gar09b}}]
  Given a dependent type theory with $\Ids$-types $\bfT$, the contextual category
...
\begin{lem}[{\cite[Lemma 2.28]{KS19}}]
  ...
  $\bfT$, the latter can also be lifted from $\Syn{T}$ to
